    ...
    <div class="relative w-full max-w-md max-h-full p-4">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 text-center md:p-5">
          ...
          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Sign up as</h3>
          ...
          <a class="text-gray-900 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center  border border-gray-200 hover:bg-gray-100 hover:text-[#6A3D1B]" href="<?= base_url('teacher-registration') ?>">Teacher</a>
          <a class="text-gray-900 font-medium  text-sm inline-flex items-center px-5 py-2.5 text-center rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#6A3D1B]" href="<?= base_url('student-registration') ?>">Student</a>
        </div>
      </div>
    </div>
  </div>

  <div id="inactive-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 items-center justify-center w-screen h-screen overflow-x-hidden overflow-y-auto bg-[#00000088] <?= $this->session->flashdata('inactive_ac') ? 'flex' : 'hidden' ?>">
    <div class="relative w-full max-w-md max-h-full p-4">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" onclick="hideModal('inactive-modal')" data-modal-hide="inactive-modal">
          <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
          </svg>
          <span class="sr-only">Close modal</span>
        ...
        <div class="p-4 text-center md:p-5">
          <svg class="w-12 h-12 mx-auto mb-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          ...
          <?php if ($this->session->flashdata('inactive_ac')) : ?>
            <div class="text-[#6A3D1B]">
              <strong><?= $this->session->flashdata('inactive_ac'); ?></strong>
            </div>
            <?php $this->session->unset_userdata('inactive_ac'); ?>
          <?php endif; ?>
        </div>
      </div>
    </div>
